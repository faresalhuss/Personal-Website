    ...
    <article className="pt-32 pb-16 sm:pt-40">
      ...
      <Section>
        <header>
          <Link
            href="/newsletter"
            className="text-xs tracking-widest text-ink-faint uppercase underline-offset-4 hover:text-lime hover:underline"
          >
            &larr; The Weekly Note
          </Link>
          <p className="mt-6 text-xs tracking-widest text-ink-faint uppercase">
        ...
        <div
          className="essay-prose mt-12"
          dangerouslySetInnerHTML={{ __html: issue.html }}
        />

        {/* Footer: subscribe CTA + canonical source link */}
        <div className="mt-16 rounded-[var(--radius-card)] border border-line bg-night-soft p-7 sm:p-9">
